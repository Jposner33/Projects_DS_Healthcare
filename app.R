...
library(stringr)
library(scales)
sahie_2010 <- read_csv("../sahie_2010.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2011 <- read_csv("../sahie_2011.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2012 <- read_csv("../sahie_2012.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2013 <- read_csv("../sahie_2013.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2014 <- read_csv("../sahie_2014.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2015 <- read_csv("../sahie_2015.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2016 <- read_csv("../sahie_2016.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2017 <- read_csv("../sahie_2017.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2018 <- read_csv("../sahie_2018.csv", skip = 79)%>% filter(state_name == "Minnesota")
sahie_2019 <- read_csv("../sahie_2019.csv", skip = 79)%>% filter(state_name == "Minnesota")
